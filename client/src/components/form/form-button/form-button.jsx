 ...
 * The button has different text content depending on whether a fetching request is being made. If a fetching request is in progress, the button is temporarily disabled.
 *
